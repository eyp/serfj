...
/**
 * Interfaz básico para hacer un controlador REST. No es necesario usar esta
 * interfaz para que la librería funcione, pero te asegura el tener las acciones
 * básicas.
 * 
 * @author eyp
 * 
...
public interface BasicRestController {
	 ...
	 * 
	 * @param params
	 *            Parámetros (identificadores de recursos) que venían en la URL.
	 */
	void index(ResponseHelper response, Map<String, String> params) throws IOException;

	/**
	 * Muestra los datos el recurso solicitado. HTTP_METHOD => GET
	 * 
	 * @param params
	 *            Parámetros (identificadores de recursos) que venían en la URL.
	 */
	...
	/**
	 * Muestra la pantalla con el formulario adecuado para insertar los datos
	 * que se usarán para crear un nuevo recurso. HTTP_METHOD => GET
	 * 
	 * @param params
	 *            Parámetros (identificadores de recursos) que venían en la URL.
	 */
	...
	/**
	 * Muestra la pantalla con el formulario adecuado para editar los datos que
	 * se usarán para modificar un recurso concreto. HTTP_METHOD => GET
	 * 
	 * @param params
	 *            Parámetros (identificadores de recursos) que venían en la URL.
	 */
	...
	/**
	 * Cera un nuevo recurso. HTTP_METHOD => POST
	 * 
	 * @param params
	 *            Parámetros (identificadores de recursos) que venían en la URL.
	 */
	...
	/**
	 * Modifica un recurso. HTTP_METHOD => PUT
	 * 
	 * @param params
	 *            Parámetros (identificadores de recursos) que venían en la URL.
	 */
	...
	/**
	 * Elimina un recurso. HTTP_METHOD => DELETE
	 * 
	 * @param params
	 *            Parámetros (identificadores de recursos) que venían en la URL.
	 */
